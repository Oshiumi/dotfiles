# Generated by Powerlevel10k configuration wizard on 2020-09-16 at 11:00 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    my_kube_fork_status     # kube fork status
  ...
  function prompt_my_kube_fork_status() {
      [[ -z $KUBE_FORK_TARGET_ENV ]] && return
      if [ $KUBE_FORK_TARGET_ENV = 'sandbox' ]; then
          p10k segment -s SANDBOX -f white -b 125 -t "Sandbox fork"
      elif [ $KUBE_FORK_TARGET_ENV = 'qa' ]; then
          p10k segment -s QA -f black -b 214 -t "QA fork"
      fi
  }
